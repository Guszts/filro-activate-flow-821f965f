  ...
  public: {
    Tables: {
      ...
      flaro_dev_attachments: {
        ...
        Relationships: [
          {
            foreignKeyName: "flaro_dev_attachments_message_id_fkey"
            columns: ["message_id"]
            isOneToOne: false
            referencedRelation: "flaro_dev_messages"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "flaro_dev_attachments_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "flaro_dev_projects"
            referencedColumns: ["id"]
          },
        ]
      }
      flaro_dev_deployments: {
        ...
        Relationships: [
          {
            foreignKeyName: "flaro_dev_deployments_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "flaro_dev_projects"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "flaro_dev_deployments_version_id_fkey"
            columns: ["version_id"]
            isOneToOne: false
            referencedRelation: "flaro_dev_versions"
            referencedColumns: ["id"]
          },
        ]
      }
      flaro_dev_domains: {
        ...
        Relationships: [
          {
            foreignKeyName: "flaro_dev_domains_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "flaro_dev_projects"
            referencedColumns: ["id"]
      ...
      flaro_dev_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "flaro_dev_messages_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "flaro_dev_projects"
            referencedColumns: ["id"]
      ...
      flaro_dev_seo: {
        ...
        Relationships: [
          {
            foreignKeyName: "flaro_dev_seo_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: true
            referencedRelation: "flaro_dev_projects"
            referencedColumns: ["id"]
      ...
      flaro_dev_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "flaro_dev_versions_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "flaro_dev_projects"
            referencedColumns: ["id"]
