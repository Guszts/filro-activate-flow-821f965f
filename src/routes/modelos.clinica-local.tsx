...
export const Route = createFileRoute("/modelos/clinica-local")({
      ...
      <Section id="contact" refSet={sectionRefs} bg="#FFFFFF" textDark>
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
          <div>
            ...
            >
              <span className="bg-black/80 text-white px-4 py-2 rounded-full text-xs inline-flex items-center gap-2"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/></svg> Clinic Location</span>
            </div>
          </div>
