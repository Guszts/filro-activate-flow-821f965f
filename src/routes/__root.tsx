...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Filro Setup — Sites e páginas profissionais para negócios locais" },
      ...
      { name: "twitter:title", content: "Filro Setup — Sites e páginas profissionais para negócios locais" },
